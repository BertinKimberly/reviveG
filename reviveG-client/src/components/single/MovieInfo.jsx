...
const MovieInfo = ({ movie, setModalOpen, DownloadMovieVideo, progress }) => {
   return (
      <div className='w-full xl:h-screen relative text-white'>
         ...
         />
         <div className='xl:bg-main bg-dry flex-colo xl:bg-opacity-90 xl:absolute top-0 left-0 bottom-0 w-full '>
            <div className='container px-3 mx-auto 2xl:px-32 xl:grid grid-cols-3 flex-colo py-10 lg:py-20 gap-8'>
               <div className='xl:col-span-1 w-full xl:order-none order-last h-header bg-dry border border-gray-8000 rounded-lg overflow-hidden '>
                  <img
               ...
               <div className='col-span-2 md:grid grid-cols-5 gap-6 items-center '>
